# -*- coding: utf-8 -*-
"""
Created on Sat Oct 19 09:15:19 2024

@author: masoo
"""

import os
os.environ['SCIKIT_LEARN_DATA'] = './mnist_Data'
...
# output dim: [n_examples, n_classes]
 ...
 # model.backward(x=X_train_mini, a_h, a_out,y=y_train_mini)    
...
# one-hot encoding
   ...
   # y_onehot = int_to_onehot(y, n_classes)
...
model = NeuralNetMLP(28*28,50,10)
import numpy as np
num_epochs = 50
minibatch_size = 100
